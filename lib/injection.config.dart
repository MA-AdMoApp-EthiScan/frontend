...
import 'package:ethiscan/app/favorites_bloc/favorites_bloc.dart' as _i22;
import 'package:ethiscan/app/parameters_bloc/parameters_bloc.dart' as _i24;
import 'package:ethiscan/app/product_bloc/product_bloc.dart' as _i19;
import 'package:ethiscan/app/scans_bloc/scans_bloc.dart' as _i25;
import 'package:ethiscan/app/user_bloc/main_user_bloc.dart' as _i23;
...
import 'package:ethiscan/data/datasources/scan_history_provider.dart' as _i21;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i20.ScanHistoryRepository>(() => _i21.ScanHistoryProvider());
    gh.factory<_i22.FavoritesBloc>(() => _i22.FavoritesBloc(
          gh<_i5.FavoriteProductRepository>(),
          gh<_i15.ProductRepository>(),
        ));
    gh.factory<_i23.MainUserBloc>(
        () => _i23.MainUserBloc(gh<_i7.AuthRepository>()));
    gh.factory<_i24.ParametersBloc>(() => _i24.ParametersBloc(
          gh<_i13.MetadataTypeRepository>(),
          gh<_i3.UserRepository>(),
        ));
    gh.factory<_i25.ScansBloc>(() => _i25.ScansBloc(
          gh<_i20.ScanHistoryRepository>(),
          gh<_i15.ProductRepository>(),
        ));
    return this;
  }
